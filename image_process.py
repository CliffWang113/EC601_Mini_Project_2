...
img_w = 100
img_h = 100
train_path_A = os.getcwd() + '/Monet/train/'
train_path_B = os.getcwd() + '/VanGogh/train/'
train_path_resized = os.getcwd() + '/resized/train/'
test_path_A = os.getcwd() + '/Monet/test/'
test_path_B = os.getcwd() + '/VanGogh/test/'
test_path_resized = os.getcwd() + '/resized/test/'
